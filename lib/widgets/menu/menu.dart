...
class Menu extends StatelessWidget {
  const Menu({this.onlyInMore = false});

  final bool onlyInMore;
  ...
  Widget _buildNestedEntry({
    ...
    leading: IconTheme(data: theme.iconTheme, child: Icon(route.selectedIcon)),
  ...
  Widget _buildEntries(BuildContext context) {
    ...
    return ListView(
      children: <Widget>[
        ...
        ..._navigation.routes
            .filter((route) => onlyInMore ? route.inMore : route.inMenu)
            .map(
              (route) => route is NestedAppRoute
                  ...
                  : _buildEntry(
                      ...
                      onTap: () =>
                          _navigation.navigateToRoute(navigator, route),
