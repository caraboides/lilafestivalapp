...
extension Localization on String {
  static final _t =
      ...
      {'en_us': 'About', 'de_de': 'Über diese App'} +
      {
      ...
      {'en_us': 'Weather data provided by:', 'de_de': 'Wetterdaten von:'} +
      {'en_us': 'Font "{font}" by:', 'de_de': 'Schriftart "{font}" von:'} +
      {'en_us': '{festivalName} App', 'de_de': '{festivalName} App'} +
      {
